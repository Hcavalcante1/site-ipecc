-- PROPOSTA TECNICA - NAO EXECUTAR SEM APROVACAO
-- Governanca de Editais e Chamamentos - Fase 1
--
-- Objetivo:
...
-- Mantem os campos atuais e adiciona controle institucional de fase.
...
-- Se ja existir coluna equivalente, revisar antes de executar.
...
-- Substitui a necessidade de criar uma tabela para cada tipo logo na primeira fase.
-- Cada documento fica ligado ao edital e, opcionalmente, a uma fase.
...
-- Registra mudanca de fase, publicacao de documento e outras acoes sensiveis.
...
-- Observacao:
-- As escritas em documentos_publicos e editais_logs devem ser feitas pela rota admin
-- usando service role, apos verifyAdminSession.

rollback;

-- Este arquivo termina com rollback por seguranca.
-- Para aplicar futuramente, trocar rollback por commit somente apos revisao.
