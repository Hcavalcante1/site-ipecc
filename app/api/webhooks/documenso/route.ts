...
import { concluirAssinaturaDocumensoWebhook } from "@/lib/documentos/signatureService";
...
/**
 * Webhook público Documenso → sincroniza PDF assinado no Storage GD.
 * Configure a URL: {SITE}/api/webhooks/documenso
 */
export async function POST(req: NextRequest) {
  ...
  const result = await concluirAssinaturaDocumensoWebhook({
    envelopeId,
    event,
  });
