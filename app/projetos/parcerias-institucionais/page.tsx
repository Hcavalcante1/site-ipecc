...
export default function ProjetosListaAdminPage() {
  const [intro, setIntro] = useState(
    "O IPECC desenvolve diferentes projetos em andamento e já realizados, em áreas como educação, cultura, esporte, inclusão social e fortalecimento comunitário."
  );
