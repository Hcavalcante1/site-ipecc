...
export default function ProjetosHeroAdminPage() {
  ...
  const [texto, setTexto] = useState(
    "Conheça os projetos desenvolvidos pelo IPECC em parceria com escolas, comunidades e órgãos públicos, promovendo educação, cultura e cidadania em diferentes territórios."
  );
