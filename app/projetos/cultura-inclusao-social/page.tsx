...
export default function ProjetosCtaAdminPage() {
  ...
  const [texto, setTexto] = useState(
    "Cada projeto do IPECC é estruturado com objetivos claros, indicadores de resultados e compromisso com a transparência. Atuamos em parceria com o poder público, escolas e organizações da sociedade civil para ampliar o acesso à educação, cultura e cidadania."
  );
