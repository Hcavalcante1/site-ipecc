...
export default function CulturaInclusaoAdminPage() {
  ...
  return (
    <>
      <div className="admin-header-block">
        <h1 className="admin-title">Projetos — Cultura e Inclusão Social</h1>
        <p className="admin-subtitle">
          Edite o conteúdo exibido na página pública /projetos/cultura-inclusao-social.
        </p>
      </div>
