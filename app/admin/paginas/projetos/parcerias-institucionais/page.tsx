...
export default function ParceriasAdminPage() {
  ...
  return (
    <>
      <div className="admin-header-block">
        <h1 className="admin-title">Projetos — Parcerias Institucionais</h1>
        <p className="admin-subtitle">
          Edite o conteúdo exibido na página pública /projetos/parcerias-institucionais.
        </p>
      </div>
