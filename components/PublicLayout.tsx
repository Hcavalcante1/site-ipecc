      ...
      <header className="header-fixo" role="banner">
        ...
        <div className="menubar-wrapper">
          <div className="container menubar__inner">
            <a href="/" className="brand" aria-label="IPECC — Início">
              <Image
            ...
            <nav className="menubar" aria-label="Menu principal">
              ...
              <a href="/quem-somos" className="menu__link">
                Quem Somos
              </a>
              <a href="/projetos" className="menu__link">
                Projetos
              </a>
              <a href="/editais" className="menu__link">
                Editais e Chamadas Públicas
              </a>
              <a href="/transparencia" className="menu__link">
                Transparência
              </a>
      ...
      <footer className="site-footer" role="contentinfo">
        <div className="container">
          <small>
            ...
            Cultura e Cidadania. Todos os direitos reservados.
          </small>
        </div>
      </footer>
    </>
